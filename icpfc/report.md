...
15:00(+69Hrs). Нельзя просто так взять и прикрутить алгоритм из нескольких частей, так чтобы он работал правильно. Где-то забыли развернуть команды, где-то два раза ботов возвращали.
